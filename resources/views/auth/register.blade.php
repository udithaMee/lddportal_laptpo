<x-guest-layout>
    ...
    <x-auth-card>
        <x-slot name="logo">
            <a href="/">
                <img src="{{asset('storage/img/logo.jpg')}}" x-application-logo class= " w-20 h-20 fill-current text-gray-500">
